                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="form-group col-6">
                                                                            ...
                                                                            <div class="input-group mb-3">
                                                                                ...
                                                                                <input type="file" name="fotos2[0][]" class="form-control" multiple>
                                                                            </div>
                                                                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            agregarCampo2Btn.addEventListener('click', function () {
                var nuevoCampo2 = campoExistente2.cloneNode(true); // Clonar el campo existente
                var collapseId2 = 'collapseExtraFields2-' + campoIndex2; // Crear un ID único para el colapso
                var collapseButton2 = nuevoCampo2.querySelector('.toggle-collapse2');

                // Actualizar el ID y atributos del collapse
                ...
                // Actualizar dinámicamente los índices de los inputs
                var inputs = nuevoCampo2.querySelectorAll('input[name^="fotos2"], input[name^="nombre_empresa2"]');
                inputs.forEach(function (input) {
                    if (input.name.startsWith('fotos2')) {
                        input.name = `fotos2[${campoIndex2}][]`; // Actualizar el índice en fotos2
                    } else if (input.name.startsWith('nombre_empresa2')) {
                        input.name = `nombre_empresa2[${campoIndex2}]`; // Actualizar el índice en nombre_empresa2
                    }
                });

                // Limpiar valores de los campos duplicados
                limpiarCampos(nuevoCampo2);

                // Agregar el nuevo campo al contenedor
                camposContainer2.appendChild(nuevoCampo2);
                campoIndex2++; // Incrementar el índice para el siguiente campo

                // Agregar eventos de cálculo u otros comportamientos necesarios
