<div class="modal fade" id="operadoresModal_Edit{{$operador->id}}" tabindex="-1" aria-labelledby="operadoresModal_Edit{{$operador->id}}Label" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col-12 form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="nombre" id="nombre" type="text" class="form-control" value="{{ $operador->nombre }}">
                        </div>
                    </div>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="correo" id="correo" type="email" class="form-control" value="{{ $operador->correo }}">
                        </div>
                    </div>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="telefono" id="telefono" type="number" class="form-control" value="{{ $operador->telefono }}">
                        </div>
                    </div>
                    ...
                    <div class="col-12 form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="domicilio" id="domicilio" type="text" class="form-control" value="{{ $operador->domicilio }}">
                        </div>
                    </div>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="fecha_nacimiento" id="fecha_nacimiento" type="date" class="form-control" value="{{ $operador->fecha_nacimiento }}">
                        </div>
                    </div>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="acceso" id="acceso" type="text" class="form-control" value="{{ $operador->acceso }}">
                        </div>
                    </div>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="tipo_sangre" id="tipo_sangre" type="text" class="form-control" value="{{ $operador->tipo_sangre }}">
                        </div>
                    </div>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="nss" id="nss" type="text" class="form-control" value="{{ $operador->nss }}">
                        </div>
                    </div>
                    ...
                    <div class="col-6 form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="recomendacion" id="recomendacion" type="text" class="form-control" value="{{ $operador->recomendacion }}">
                        </div>
                    </div>
